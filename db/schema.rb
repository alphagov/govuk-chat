...
ActiveRecord::Schema[8.0].define(version: 2025_06_27_132815) do
  ...
  create_enum "question_routing_label", ["about_mps", "advice_opinions_predictions", "character_fun", "genuine_rag", "gov_transparency", "greetings", "harmful_vulgar_controversy", "multi_questions", "negative_acknowledgement", "non_english", "personal_info", "requires_account_data", "positive_acknowledgement", "vague_acronym_grammar", "unclear_intent"]
