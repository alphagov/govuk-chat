...
ActiveRecord::Schema[7.1].define(version: 2024_04_05_083909) do
  ...
  create_enum "status", ["success", "error_non_specific", "error_answer_service_error", "abort_forbidden_words"]
