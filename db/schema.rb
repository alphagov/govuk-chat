...
ActiveRecord::Schema[7.1].define(version: 2024_07_23_131031) do
  ...
  create_enum "status", ["success", "error_non_specific", "error_answer_service_error", "abort_forbidden_words", "error_context_length_exceeded", "abort_no_govuk_content", "abort_timeout", "abort_output_guardrails", "error_output_guardrails", "error_invalid_llm_response"]
