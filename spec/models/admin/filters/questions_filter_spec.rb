RSpec.describe Admin::Filters::QuestionsFilter do
  ...
  describe "#results" do
    ...
    it "filters the results by primary topic" do
      business_answer = build(:answer, topics: build(:answer_topics, primary_topic: "business"))
      business_question = create(:question, answer: business_answer)
      tax_answer = build(:answer, topics: build(:answer_topics, primary_topic: "tax"))
    ...
    it "filters the results by secondary topic" do
      business_answer = build(:answer, topics: build(:answer_topics, secondary_topic: "business"))
      business_question = create(:question, answer: business_answer)
      tax_answer = build(:answer, topics: build(:answer_topics, secondary_topic: "tax"))
      tax_question = create(:question, answer: tax_answer)
  ...
  def create_paginatable_filter(attrs = {})
    ...
    26.times do
      ...
      create(:answer_topics, answer:, primary_topic: "business", secondary_topic: "tax")
    end
