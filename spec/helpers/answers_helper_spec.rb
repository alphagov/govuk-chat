RSpec.describe AnswersHelper do
  ...
  describe "#combined_llm_responses" do
    ...
    it "returns nested arrays of the combined llm_responses sorted alphabetically per model" do
      ...
      expect(helper.combined_llm_responses(answer)).to eq(expected_result)
    end
  ...
  describe "#combined_metrics" do
    ...
    it "returns the combined metrics of the answer and its analysis" do
      ...
      expect(helper.combined_metrics(answer)).to eq(expected_result)
    end
