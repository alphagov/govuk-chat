  ...
  describe "GET :show" do
    ...
    context "when analysis is present" do
      ...
      it "renders the question details in the details tab" do
        ...
        details_tab = document.at_css("#details-tab")

        expect(details_tab.text).to include(question.message)
      end
      ...
      it "renders the analysis in the analysis tab" do
        ...
        document = Nokogiri::HTML(response.body)
        details_tab = document.at_css("#analysis-tab")

        expect(details_tab.text)
         .to include(analysis.primary_topic.capitalize)
         .and include(analysis.secondary_topic.capitalize)
      end
    end
  end
