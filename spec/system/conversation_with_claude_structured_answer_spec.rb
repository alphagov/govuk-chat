RSpec.describe "Conversation with Claude with a structured answer", :aws_credentials_stubbed, :chunked_content_index do
  ...
  def when_the_first_answer_is_generated
    ...
    stub_anthropic_claude_jailbreak_guardrails_response(@first_question, triggered: false)
    stub_anthropic_claude_question_routing(@first_question)
    stub_anthropic_claude_structured_answer_response(@first_question, @first_answer)
    stub_anthropic_guardrails(@first_answer, "False | None")
  ...
  def when_the_second_answer_is_generated
    ...
    stub_anthropic_claude_jailbreak_guardrails_response(@second_question, triggered: false)
    stub_anthropic_question_rephrasing(@second_question, rephrased_question)
    stub_anthropic_claude_question_routing(rephrased_question)
    stub_anthropic_claude_structured_answer_response(rephrased_question, @second_answer)
    stub_anthropic_guardrails(@second_answer, "False | None")
