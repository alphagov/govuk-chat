...
Rails.application.routes.draw do
  ...
  scope :chat, format: false, defaults: { format: "html" }, constraints: html_constraint do
    ...
    get "unsubscribe/early-access-users/:id/:token", to: "unsubscribe#early_access_user", as: :early_access_user_unsubscribe
    get "unsubscribe/waiting-list-users/:id/:token", to: "unsubscribe#waiting_list_user", as: :waiting_list_user_unsubscribe
  end
