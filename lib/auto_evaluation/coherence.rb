module AutoEvaluation
  ...
  private
    ...
    def normalise_rubric_score(rubric_score)
      min_rubric_score = llm_prompts.fetch(:min_rubric_score)
      max_rubric_score = llm_prompts.fetch(:max_rubric_score)

      (rubric_score.to_f - min_rubric_score) / (max_rubric_score - min_rubric_score)
    end
  end
end
