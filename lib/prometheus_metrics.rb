class PrometheusMetrics
  ...
  COUNTERS = [
    {
      name: "answer_aggregate_status_total",
      description: "The total number of answers by aggregate status. For example, 'error', 'unanswerable', and 'answered'",
    },
  ].freeze
