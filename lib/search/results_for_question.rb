module Search
  class ResultsForQuestion
    ...
    def self.call(question_message)
      ...
      metrics = {}
      embedding_start_time = AnswerComposition.monotonic_time
      embedding = Search::TextToEmbedding.call(question_message)
      metrics[:embedding_duration] = AnswerComposition.monotonic_time - embedding_start_time

      search_start_time = AnswerComposition.monotonic_time
      results = ChunkedContentRepository.new.search_by_embedding(embedding, max_chunks:)
      metrics[:search_duration] = AnswerComposition.monotonic_time - search_start_time

      reranking_start_time = AnswerComposition.monotonic_time
      ...
      metrics[:reranking_duration] = AnswerComposition.monotonic_time - reranking_start_time
