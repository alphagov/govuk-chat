module AnswerComposition::Pipeline::Claude
  ...
  private
    ...
    def system_prompt
      sprintf(claude_prompts[:system_prompt], context: system_prompt_context)
    end
    ...
    def claude_prompts
      Rails.configuration.govuk_chat_private.llm_prompts.claude.structured_answer
    end
    ...
    def tools
      [{ tool_spec: claude_prompts[:tool_spec] }]
    end
  end
end
